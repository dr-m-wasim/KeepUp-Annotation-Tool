...
class PostFeatures(models.Model):
    event_id = models.TextField(db_column='Event-id', blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
    ...
    post_label = models.TextField(db_column='post-label', blank=True, null=True)  # Field renamed to remove unsuitable characters.
