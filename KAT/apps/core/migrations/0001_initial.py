# Generated by Django 4.2.16 on 2025-05-11 02:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("username", models.CharField(blank=True, max_length=51, null=True)),
                ("followers", models.CharField(blank=True, max_length=17, null=True)),
                ...
                (
                    "posts_count",
                    models.CharField(
                        blank=True, db_column="posts count", max_length=13, null=True
                    ),
                ),
                (
                    "joining_date",
                    models.CharField(
                        blank=True, db_column="joining date", max_length=24, null=True
                    ),
                ),
            ],
            options={
